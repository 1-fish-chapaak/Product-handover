    ...
    <AnimatePresence>
      ...
      >
        ...
        <motion.div
          ...
          className="relative bg-white rounded-[16px] border border-canvas-border shadow-2xl w-[840px] max-w-[calc(100vw-48px)] max-h-[calc(100vh-48px)] flex flex-col overflow-hidden"
        >
          {/* Header */}
          <div className="flex items-start justify-between gap-4 px-6 pt-5 pb-4 border-b border-canvas-border">
            <div className="flex items-start gap-3 min-w-0">
              ...
              <div className="min-w-0">
                <h3 id="query-widget-title" className="text-[16px] font-bold text-ink-800 tracking-tight">
                  Choose What to Include
                </h3>
                <p className="text-[12px] text-ink-500 mt-0.5 truncate">
                  <span className="font-mono text-[11px] text-brand-600">{queryId}</span>
            ...
            {totalItems === 0 ? (
              ...
              <div className="space-y-5">
                ...
                <div className="flex items-center justify-between gap-2">
                  <p className="text-[12px] text-ink-400" aria-live="polite">
                    {totalSelected === 0
                  ...
                  <div className="flex items-center gap-3">
                    <button
                      type="button"
                      onClick={selectAll}
                      className="text-[11px] font-semibold text-brand-600 hover:text-brand-500 cursor-pointer"
                    >
                      Select all
                    </button>
                    <button
                      type="button"
                      onClick={clearAll}
                      className="text-[11px] font-semibold text-ink-400 hover:text-ink-800 cursor-pointer"
                    >
                      Clear
                    </button>
                  </div>
                          ...
                          return (
                            ...
                            >
                              <div className="flex items-center gap-2 mb-2">
                                ...
                                <span className="text-[12px] font-semibold text-ink-800 truncate">{g.title}</span>
                              </div>
          ...
          <div className="flex items-center justify-end gap-2.5 px-6 py-4 border-t border-canvas-border bg-paper-50/40">
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-1.5 h-9 px-5 text-[13px] font-semibold text-white bg-brand-600 hover:bg-brand-500 rounded-[8px] transition-colors cursor-pointer"
            >
              <FileText size={14} />
              Add to Card
            </button>
