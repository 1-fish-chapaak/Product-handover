...
function brandBanner(ctx: ReportExportContext): string {
  ...
  return `<table width="100%" cellpadding="0" cellspacing="0">
    <tr><td bgcolor="${BRAND_DARK}" style="background:${BRAND_DARK};background:linear-gradient(135deg, ${BANNER_FROM}, ${BANNER_TO});padding:34px 36px;">
      ...
      ${byline ? `<p style="color:${BANNER_BYLINE};font-size:10pt;margin:8px 0 0;">${byline}</p>` : ''}
    </td></tr>
  </table>`;
}
