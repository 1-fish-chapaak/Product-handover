  ...
  return (
    <div className="flex items-start gap-2 rounded-md border border-canvas-border/70 bg-white px-2.5 py-2">
      ...
      <div className="min-w-0 flex-1">
        ...
        {/* The structure that was kept, said plainly. */}
        {block.kind === 'table' && (
...
function SectionRow({ section, index, total, flashed, registerRef, onRename, onDescribe, onFill, onDelete, onJump, onMerge, onWrapper }: {
