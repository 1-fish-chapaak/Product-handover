...
function TemplateThumb({ accent }: { accent: 'excel' | 'word' }) {
  return (
    <div className="rounded-[8px] border border-canvas-border bg-canvas overflow-hidden mb-3 select-none" aria-hidden="true">
  ...
  return (
    <div className="min-h-full flex flex-col justify-center">
      <div className="w-full max-w-[780px] mx-auto">
        <h2 className="text-[1.0625rem] font-semibold text-ink-900 mb-0.5 text-center">Download a template</h2>
        <p className="text-[0.8125rem] text-ink-500 mb-4 text-center">Pick a format, fill it offline with one observation per row, then upload it below.</p>

        <div className="grid sm:grid-cols-2 gap-4 mb-4">
          {/* Excel */}
          <div className="rounded-[12px] border border-canvas-border bg-canvas-elevated p-4" title="Best for many observations and structured exception data — extracts most reliably.">
            ...
            <p className="text-[12px] text-ink-500 mb-3">Spreadsheet with one row per observation. Best for clean, structured extraction.</p>
          ...
          {/* Word */}
          <div className="rounded-[12px] border border-canvas-border bg-canvas-elevated p-4" title="Best for narrative observations written as prose tables.">
            ...
            <p className="text-[12px] text-ink-500 mb-3">One table per observation. Best when you write findings as narrative prose.</p>
        ...
        <div className="rounded-[12px] border border-canvas-border bg-canvas px-4 py-4">
