    ...
    <div>
      ...
      <div className="flex items-start justify-between gap-4 mb-4">
        <div>
          ...
          <p className="text-[0.8125rem] text-ink-500 mt-0.5">{eng.controls.length} controls · <span className="font-semibold text-mitigated-700">{testsDueNow(eng.controls).length} tests due now</span> · {stats.effective} effective · {stats.waitingOnOwner} waiting on owner</p>
        </div>
