        ...
        >
          <div className="flex items-center gap-2 px-4 sm:px-6 py-2 bg-[#6a12cd]/6 border-b border-[#6a12cd]/15" style={{ display: "none" }}>
            ...
            <div className="flex items-center gap-1.5 shrink-0">
              ...
              <span className="text-[0.6875rem] text-[#6a12cd] font-['Inter:SemiBold',sans-serif] whitespace-nowrap">
                {isInteractive
                  ? doubleDrillPending
            ...
            <div className="flex items-center gap-1 flex-wrap min-w-0">
              ...
              <button
                ...
                className="text-[0.6875rem] text-[#6a12cd]/60 hover:text-[#6a12cd] transition-colors font-['Inter:Regular',sans-serif] px-1.5 py-0.5 rounded hover:bg-[#6a12cd]/10 shrink-0"
              >
                ...
                return (
                  <div key={i} className="flex items-center gap-1 shrink-0">
                    ...
                    <button
                      ...
                      className={`text-[0.6875rem] px-1.5 py-0.5 rounded transition-all font-['Inter:Regular',sans-serif] ${
                        isActive
            ...
            <div className="ml-auto flex items-center gap-1 shrink-0">
              <button
                onClick={resetHierarchy}
                className="flex items-center gap-1 px-2 py-0.5 text-[0.625rem] text-gray-400 hover:text-red-500 hover:bg-red-50 rounded-lg transition-colors border border-transparent hover:border-red-200"
              >
