/**
 * Scanner — WebGL "signal field" background (React Bits, adapted to TSX).
 * A violet/pink scan band sweeps across fine interference lines. Used as the
 * dark backdrop of the Smart Queries modal. Renders into a full-size canvas;
 * pauses itself when off-screen or the tab is hidden.
 */
