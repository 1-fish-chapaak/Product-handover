              ...
              {options.map((opt) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full text-left px-2.5 py-1.5 text-[0.75rem] flex items-center gap-1.5 transition-colors ${selected ? 'bg-brand-50 text-brand-700 font-semibold' : 'text-ink-600 hover:bg-canvas'}`}
                  >
                    <span
                      className="w-[5px] h-[5px] rounded-full shrink-0"
                    ...
                    <span className="text-[0.75rem] text-ink-400 truncate max-w-[70px]">{opt.file}</span>
                  </button>
                );
              })}
            </div>
    ...
    return (
      <div>
        ...
        <div className="grid grid-cols-[1fr_auto_1fr] items-center gap-1.5 px-2 py-1.5 rounded-lg bg-canvas">
          {pill('src')}
          <span className="text-[0.75rem] text-ink-400 font-semibold">vs</span>
          {pill('tgt')}
        </div>
      </div>
    );
      ...
      >
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <div className="text-[0.8125rem] font-semibold text-ink-800">{label}</div>
            ...
            {r.columns && r.enabled && !r.expanded && (
              <div className="flex items-center gap-1 mt-1 flex-wrap">
                <span className="inline-flex items-center gap-1 text-[0.75rem] font-semibold text-ink-500 bg-canvas border border-canvas-border rounded px-1.5 py-0.5">
                  <span
                    className="w-[5px] h-[5px] rounded-full shrink-0"
                ...
                <span className="text-[0.75rem] text-ink-300 font-semibold">vs</span>
                <span className="inline-flex items-center gap-1 text-[0.75rem] font-semibold text-ink-500 bg-canvas border border-canvas-border rounded px-1.5 py-0.5">
                  <span
                    className="w-[5px] h-[5px] rounded-full shrink-0"
          ...
          {customRules.map((cr, ci) => {
            ...
            return (
              ...
              >
                ...
                >
                  <div
                    className="w-7 h-7 rounded-lg flex items-center justify-center shrink-0 text-[0.75rem] font-semibold"
                    style={{ background: st.bg, color: st.color }}
                  >
                    {cr.icon}
                  </div>
                  <div className="flex-1 min-w-0">
                    <div className="text-[0.8125rem] font-semibold text-ink-800">{cr.name}</div>
                    <div className="flex items-center gap-1.5 mt-0.5 flex-wrap">
                ...
                {cr.enabled && cr.expanded && cr.columns && (
                  <div className="px-3 pb-3 border-t border-canvas-border">
                    <div className="pt-3 space-y-3">
                      ...
                      <div className="text-[0.8125rem] font-semibold text-center py-2 text-brand-700">
                        {cr.threshold}
                      </div>
                    </div>
                  </div>
      ...
      {builderOpen && (
        ...
        >
          ...
          >
            ...
            <span className="text-[0.8125rem] font-semibold flex-1 text-ink-900">Build custom rule</span>
            <button
              type="button"
          ...
          <div className="px-3 py-3">
                ...
                <div className="grid grid-cols-2 gap-2">
                  {(
                    ...
                    >
                      ...
                      <div className="text-[0.75rem] text-ink-400 mt-0.5 leading-snug">{t.desc}</div>
                    </button>
                  ))}
                </div>
              </div>
                    ...
                    {(['src1', 'src2'] as const).map((key) => {
                      ...
                      return (
                        <div key={key} className="mb-2">
                          <div className="flex items-center gap-1.5 text-[0.75rem] font-semibold text-ink-500 mb-1">
                            <span
                          ...
                          <div className="flex flex-wrap gap-1.5 pl-3">
                            {grp.cols.map((c) => (
                              <button
                                ...
                                className="px-2.5 py-1.5 rounded-lg text-[0.75rem] font-semibold border transition-all cursor-pointer"
                                style={
            ...
            {builderStep === 4 && (
              <div>
                <div className="text-[0.8125rem] font-semibold text-ink-800 mb-1">Name this rule</div>
                <div className="text-[0.75rem] text-ink-400 mb-3">
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-canvas-border rounded-lg text-[0.8125rem] font-semibold text-ink-800 outline-none focus:border-brand-400 transition-colors placeholder:text-ink-300"
                />
                <div className="flex items-center gap-1 mt-1.5 text-[0.75rem] text-ink-400">
                ...
                <div className="mt-3 rounded-lg p-3 bg-canvas">
                  <div className="flex items-center gap-2 text-[0.75rem] py-1">
            ...
            <div className="flex items-center gap-2 mt-4 pt-3 border-t border-canvas-border">
              {builderStep > 1 && (
                <button
                  ...
                  className="inline-flex items-center gap-1 rounded-md text-[0.75rem] font-semibold px-2.5 py-1.5 text-ink-600 bg-canvas hover:bg-canvas-border/40 border border-canvas-border transition-colors cursor-pointer"
                >
                  Back
                </button>
              )}
              ...
              <button
                ...
                className="inline-flex items-center gap-1 rounded-md text-[0.75rem] font-semibold px-2.5 py-1.5 bg-brand-600 hover:bg-brand-500 text-white disabled:bg-brand-100 disabled:text-brand-300 disabled:cursor-not-allowed cursor-pointer transition-colors"
              >
              ...
              {(() => {
                ...
                return filtered.length > 0 ? (
                  <div className="py-1 border-b border-canvas-border">
                    <div className="text-[0.75rem] font-bold text-ink-400 uppercase tracking-wide px-3 py-1">
                      Preconfigured
                    </div>
                    {filtered.map((p) => {
                      ...
                      return (
                        ...
                        >
                          <div
                            className="w-7 h-7 rounded-lg flex items-center justify-center text-[0.75rem] font-semibold shrink-0"
                            style={{ background: st.bg, color: st.color }}
                          >
                            {p.icon}
                          </div>
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="text-[0.75rem] text-ink-400 mt-0.5">{p.desc}</div>
                          </div>
                          <span
                            className="text-[0.75rem] font-semibold px-2 py-1 rounded-md"
            ...
            <div className="space-y-0.5">
              {impactSamples.map(({ a, b, pct, type, typeLabel, diff }, i) => {
                ...
                return (
                  ...
                  >
                    <div className="flex-1 min-w-0 text-[0.75rem] text-ink-500">
                      <span className="font-semibold text-ink-700">{a}</span>
                      <span className="mx-1">vs</span>
                      <span className="font-semibold text-ink-700">{b}</span>
                      <span className="text-ink-400 ml-1 text-[0.75rem]">{pct}</span>
                    </div>
                    <span
                      className="text-[0.75rem] font-bold uppercase px-1.5 py-0.5 rounded tracking-wide"
        ...
        <div>
          ...
          <div className="flex items-center gap-2">
            <div className="flex items-center flex-1 border border-canvas-border rounded-lg overflow-hidden focus-within:border-brand-400/50 focus-within:ring-2 focus-within:ring-brand-100 transition-all">
              <span className="text-[0.75rem] font-semibold text-ink-400 pl-3 pr-1 select-none">$</span>
              <input
                type="number"
                min={0}
                step={50}
  ...
  return (
    <>
      <div className="flex items-center justify-center gap-1">
        ...
        <span className="text-[0.8125rem] text-ink-400 ml-1">days</span>
        <span
...
function BuilderThresholdStep({
  ...
  return (
    <div>
      <div className="text-[0.8125rem] font-semibold text-ink-800 mb-1">{title}</div>
