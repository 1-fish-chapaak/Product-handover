  ...
  if (running && !result) {
    return (
      <div className="flex items-center gap-2 rounded-xl border border-canvas-border bg-canvas-elevated px-3 py-2.5">
        ...
        <div className="text-[0.8125rem] text-ink-700">
  ...
  return (
    ...
    >
      ...
      <section className="rounded-xl bg-brand-50/50 border border-brand-100 p-4">
        <div className="inline-flex items-center gap-1.5 text-[0.75rem] font-semibold text-brand-700 bg-canvas-elevated/80 border border-brand-100 rounded-full px-2 py-1 mb-2 uppercase tracking-wide">
          <Sparkles size={11} />
          AI Summary
        </div>
      ...
      {/* Key Observations */}
      <div>
        <h2 className="text-[0.9375rem] font-semibold text-ink-900 mb-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
          {insights.map((o) => {
            ...
            return (
              <div
                key={o.id}
                className="rounded-lg border border-canvas-border bg-canvas-elevated p-3"
              >
                ...
                <p className="text-[0.8125rem] text-ink-600 leading-relaxed mb-2">{o.body}</p>
                <span
                  className={`inline-flex items-center text-[0.75rem] font-semibold rounded-md px-2 py-0.5 ${o.priorityColor}`}
                >
                  {o.priority}
                </span>
              </div>
