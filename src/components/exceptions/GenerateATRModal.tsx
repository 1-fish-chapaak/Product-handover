...
export default function GenerateATRModal({
  ...
  return (
    <>
      ...
      >
        {/* Title bar */}
        <header className="atr-no-print shrink-0 px-6 py-3 flex items-center justify-between gap-4 border-b border-canvas-border">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[0.75rem] text-ink-500 leading-snug">Live preview · read-only</p>
            </div>
          </div>
          <button
            onClick={onClose}
