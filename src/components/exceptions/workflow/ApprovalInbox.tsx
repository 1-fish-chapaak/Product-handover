...
export default function ApprovalInbox({ exceptions }: { exceptions: GrcException[] }) {
  const { currentUserId, assignments, decide } = useWorkflow();
  ...
  return (
    <div className="space-y-4">
      {pending.map(a => {
        ...
        if (!ex || !lvl) return null;
        const reason = canAct(a, currentUserId).reason;
        // Prior-level comments the approver is entitled to see.
        ...
        return (
          <div key={a.id} className="border border-canvas-border rounded-[12px] bg-canvas-elevated overflow-hidden">
            ...
            <div className="grid md:grid-cols-[1fr_240px]">
              <div className="p-5 space-y-4">
                ...
                {/* Everything the assignee saw (approver entitlement) */}
