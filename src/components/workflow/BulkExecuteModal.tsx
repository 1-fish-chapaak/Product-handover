...
function Pill({
  ...
  return (
    <button
      ...
      onClick={onClick}
      disabled={disabled}
      className={`px-3.5 h-8 rounded-lg text-[0.78125rem] font-semibold transition-colors ${
        disabled
                  ...
                  <div key={w.id}>
                    <div className="flex items-center gap-3 px-3 py-2.5 hover:bg-surface-2/60 transition-colors">
                      ...
                      <button
                        ...
                        className="inline-flex items-center gap-1.5 px-2.5 h-7 rounded-md border border-border-light bg-white text-[0.75rem] font-semibold text-text-secondary hover:border-primary/30 hover:text-text transition-colors cursor-pointer shrink-0"
                      >
                          ...
                          {DEFAULT_CONFIG_FIELDS.map(field => (
                            <div key={field.key}>
                              <div className="flex items-center gap-1.5 mb-1">
                                <label className="text-[0.75rem] font-semibold text-text">{field.key}</label>
                                <span className="text-[0.65625rem] font-mono text-text-muted">{field.type}</span>
                              </div>
                              <input
                                value={config[field.key] ?? field.defaultValue}
                                onChange={e => updateField(field.key, e.target.value)}
                                className="w-full px-3 py-2 rounded-md border border-border-light bg-white text-[0.78125rem] text-text outline-none focus:border-primary/40 focus:ring-2 focus:ring-primary/10 transition-all"
                              />
                            </div>
                          ))}
                        </div>
                  ...
                  >
                    <div className="flex items-center gap-2 mb-1.5 flex-wrap">
                      ...
                      {file.usedBy.map(wf => (
                        <span
                          key={wf}
                          className="inline-flex items-center px-2 py-0.5 rounded-md bg-white border border-border-light text-[0.6875rem] text-text-secondary"
                        >
                          {wf}
                        </span>
                      ))}
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 mb-3">
                      <button
                        ...
                        className={`inline-flex items-center gap-1.5 h-9 px-4 rounded-md border text-[0.78125rem] font-semibold transition-colors cursor-pointer ${
                              ...
                              {filteredDataSources.map(ds => {
                                ...
                                return (
                                  ...
                                  >
                                    ...
                                    <div className="flex-1 min-w-0">
                                      <div className="text-[0.78125rem] font-semibold text-text truncate">{ds.name}</div>
              ...
              <div className="px-4 pt-4 pb-3">
                <div className="flex items-start justify-between gap-3 mb-3">
                  <div className="min-w-0">
                    ...
                    <div className="text-[0.71875rem] text-text-muted mt-0.5">
                  ...
                  {([
                    ...
                    return (
                      <button
                        ...
                        className={`inline-flex items-center gap-1.5 h-7 px-3 rounded-full border text-[0.71875rem] font-medium transition-colors cursor-pointer ${
                          active
                      ...
                      >
                        ...
                        {chip.label}
                        <span className={`font-mono text-[0.65625rem] ${active ? 'opacity-70' : 'opacity-60'}`}>
                          {chip.count}
                        </span>
                      </button>
                    );
                        ...
                        <div className="flex items-center gap-3 px-4 py-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2 mb-0.5">
                              <span className={`text-[0.78125rem] font-medium truncate ${isDropped ? 'text-text-muted line-through' : 'text-text'}`}>
                                {rw.name}
                              </span>
                            ...
                            {rw.status === 'sql' && (
                              <label className="inline-flex items-center gap-1.5 text-[0.71875rem] text-text-muted cursor-pointer select-none mt-1.5">
                                <input
                                  type="checkbox"
              ...
              <div className="px-4 pt-4 pb-3">
                <div className="flex items-center justify-between gap-3 mb-1">
                  <div className="flex items-center gap-2.5 min-w-0">
                    <div className="text-[0.8125rem] font-semibold text-text">Workflow Mapping</div>
                    <span className="inline-flex items-center gap-1 text-[0.65625rem] font-medium text-primary bg-primary/8 px-1.5 py-0.5 rounded-full">
                      <Sparkles size={10} />
                      Auto-mapping complete
                    </span>
                  </div>
                </div>
                <div className="text-[0.71875rem] text-text-muted mb-3">
                          ...
                          <div className="flex items-center gap-3 px-3.5 py-2.5">
                            <div className="flex-1 min-w-0">
                              <div className="flex items-center gap-2 mb-0.5 flex-wrap">
                                <span className="font-mono text-[0.65625rem] text-text-muted/70 shrink-0">{rw.code}</span>
                                <span className={`text-[0.78125rem] font-medium truncate ${isDropped ? 'text-text-muted line-through' : 'text-text'}`}>
                                  {rw.name}
                                </span>
                                <ReviewStatusChip status={rw.status} />
    ...
    <div className="flex-1 flex flex-col items-center justify-center px-8 py-16">
      ...
      <div className="w-full max-w-[360px] space-y-2">
        {steps.map((s, i) => {
          ...
          return (
            <div key={s} className="flex items-center gap-2.5 text-[0.78125rem]">
    ...
    <div className="rounded-lg border border-border-light bg-white">
      <div className="flex items-center gap-3 px-3 py-2.5 border-b border-border-light">
        ...
        <div className="flex items-center gap-2 flex-1 min-w-0">
          ...
          {failed > 0 && (
            <div className="flex items-center gap-1 text-[0.71875rem] text-risk min-w-0">
        ...
        {files.map(u => {
          ...
          return (
            <div key={u.id} className="flex items-center gap-3 px-3 py-2.5">
              ...
              <div className="flex-1 min-w-0">
                <div className="text-[0.78125rem] font-semibold text-text truncate">{u.name}</div>
                <div className="text-[0.6875rem] text-text-muted">{humanSize(u.size)}</div>
              </div>
              {u.error && (
                <div className="flex items-center gap-1.5 text-[0.71875rem] text-risk shrink-0">
...
function ReviewStatusChip({ status }: { status: ReviewWorkflowStatus }) {
  const base = 'inline-flex items-center gap-1 px-2 h-5 rounded-full text-[0.65625rem] font-medium tracking-wide shrink-0 border';
  switch (status) {
    case 'mapped':
      return (
...
function ReviewActionButton({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className={`inline-flex items-center px-2.5 h-7 rounded-md border text-[0.71875rem] font-medium transition-colors cursor-pointer ${cls}`}
    >
      {children}
    </button>
  );
  ...
  return (
    <div className="border-t border-dashed border-border-light bg-surface-2/40 px-4 py-3.5">
      <div className="flex items-start justify-between mb-3 gap-3">
        <div className="min-w-0">
          <div className="text-[0.71875rem] font-semibold text-text">Column Mapping</div>
          <div className="text-[0.65625rem] text-text-muted mt-0.5">
            Map required schema columns to columns found in uploaded file. Fuzzy matches are auto-applied — verify or override.
          </div>
        </div>
        <div className="text-[0.65625rem] font-mono text-text-muted shrink-0">
          {resolved}/{columns.length} resolved
        </div>
      </div>

      <div className="rounded-lg border border-border-light bg-white p-3">
        <div className="grid grid-cols-[1fr_18px_1fr_60px] gap-3 text-[0.59375rem] uppercase tracking-wider text-text-muted/80 font-semibold pb-1.5 border-b border-border-light">
        ...
        {columns.map((c, idx) => (
          ...
          >
            ...
            <select
              ...
              className={`min-w-0 px-2 h-7 rounded-md border text-[0.71875rem] font-mono outline-none transition-colors cursor-pointer ${
            ...
            <div className="flex justify-end">
              {c.confidence === 'exact' && (
                <span className="inline-flex items-center px-1.5 h-5 rounded text-[0.59375rem] font-medium bg-compliant-50 text-compliant-700 border border-compliant/25">
                  exact
                </span>
              )}
              {c.confidence === 'fuzzy' && (
                <span className="inline-flex items-center px-1.5 h-5 rounded text-[0.59375rem] font-medium bg-mitigated-50 text-mitigated-700 border border-mitigated/30">
                  fuzzy
                </span>
              )}
              {c.confidence === 'missing' && (
                <span className="inline-flex items-center px-1.5 h-5 rounded text-[0.59375rem] font-medium bg-risk/10 text-risk border border-risk/30">
                  missing
                </span>
              )}
            </div>
      ...
      <div className="flex items-center justify-between mt-3 gap-3">
        <div className="text-[0.65625rem] flex items-center gap-1.5 min-w-0">
          {allResolved ? (
            <>
        ...
        <button
          ...
          className={`inline-flex items-center px-2.5 h-7 rounded-md border text-[0.71875rem] font-medium transition-colors shrink-0 ${
            allResolved
      ...
      <div className="flex-1 overflow-y-auto px-6 py-5">
        <div className="mb-5">
          <div className="flex items-start justify-between gap-4">
            <div className="min-w-0">
              <div className="text-[0.65625rem] font-semibold uppercase tracking-wider text-primary mb-1">Final Review</div>
            ...
            <div className="text-[0.71875rem] text-text-muted shrink-0 pt-1 whitespace-nowrap">
        ...
        <div className="rounded-xl bg-primary/5 border border-primary/20 p-4 mb-4 flex items-center gap-3">
          ...
          <button
            type="button"
            className="inline-flex items-center px-2.5 h-7 rounded-md border border-border-light bg-white text-[0.71875rem] font-medium text-text hover:bg-surface-2 transition-colors cursor-pointer shrink-0"
          >
            Rename
          </button>
        </div>
            ...
            <div className="px-3 pb-3 space-y-2 bg-white">
              {overrides.map(w => (
                <div key={w.id} className="pt-2.5 border-t border-border-light first:border-t-0">
                  <div className="text-[0.78125rem] font-medium text-text mb-1.5">
                    {w.name}
                    <span className="font-mono text-[0.65625rem] text-text-muted ml-1.5">{w.code}</span>
                  </div>
                  <div className="space-y-0.5">
                    {(w.columns ?? []).filter(c => c.confidence !== 'missing').map((c, idx) => (
                      <div key={idx} className="flex items-center gap-2 text-[0.6875rem] font-mono">
                        ...
                        <span className={`ml-auto inline-flex items-center px-1.5 h-4 rounded text-[0.59375rem] font-medium border ${
                          c.confidence === 'fuzzy'
        ...
        <div className="mb-4">
          <div className="text-[0.65625rem] font-semibold uppercase tracking-wider text-text-muted mb-2">
          ...
          <div className="rounded-xl border border-border-light bg-white divide-y divide-border-light overflow-hidden">
            {active.map(w => (
              <div key={w.id} className="flex items-center gap-3 px-4 py-2.5">
                ...
                <div className="flex-1 text-[0.78125rem] text-text truncate">{w.name}</div>
                {w.hasOverrides && (
                  <span className="inline-flex items-center px-1.5 h-5 rounded text-[0.59375rem] font-medium bg-mitigated-50 text-mitigated-700 border border-mitigated/30 shrink-0">
                    overrides
                  </span>
                )}
            ...
            <div className="rounded-xl border border-border-light bg-surface-2/40 divide-y divide-border-light/60 overflow-hidden">
              {skipped.map(w => (
                <div key={w.id} className="flex items-center gap-3 px-4 py-2.5">
                  ...
                  <div className="font-mono text-[0.6875rem] text-text-muted/70 w-16 shrink-0">{w.code}</div>
                  <div className="flex-1 text-[0.78125rem] text-text-muted line-through truncate">{w.name}</div>
    ...
    >
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto px-5 py-5 space-y-4">
          <div className="text-[0.71875rem] text-text-muted">
